...
<body>
    ...
    if ($exists) {
        ...
        <div class="alert alert-danger d-flex align-items-center" role="alert" style="height: 48px; margin-bottom: 0; position: absolute; left: 41%; top:69px;">
        ...
        <div class="alert alert-danger d-flex align-items-center" role="alert" style="height: 48px; margin-bottom: 0; position: absolute; left: 40%; top:69px;">
            <svg class="bi flex-shrink-0 me-2" role="img" aria-label="Danger:" style="width: 18px">
                <use xlink:href="#exclamation-triangle-fill" />
            </svg>
            <div>
        ...
        <div class="alert alert-primary d-flex align-items-center" role="alert" style="height: 48px; margin-bottom: 0; position: absolute; left: 38.2%; top:69px;">
